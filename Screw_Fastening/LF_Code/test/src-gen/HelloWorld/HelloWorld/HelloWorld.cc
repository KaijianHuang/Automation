...
// outer constructor
HelloWorld::HelloWorld(const std::string& name, reactor::Environment* __lf_environment, Parameters&& __lf_parameters)
...
HelloWorld::HelloWorld(const std::string& name, reactor::Reactor* __lf_container, Parameters&& __lf_parameters)
...
// inner constructor
HelloWorld::Inner::Inner(::reactor::Reactor* reactor, Parameters&& __lf_parameters)
  : LFScope(reactor)
  , Parameters(std::forward<Parameters>(__lf_parameters))
  // state variables
{}

void HelloWorld::assemble() {
